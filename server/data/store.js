...
const VERIFIED_MEDIA_LIBRARY = {
  ...
  'ford-f650-box-truck-2022': {
    heroImage: buildCommonsFilePath('Ford Medium-Duty Super Duty F-650 - Two Men and a Truck, box truck.jpg'),
    gallery: [
      buildCommonsFilePath('Ford Medium-Duty Super Duty F-650 - Two Men and a Truck, box truck.jpg'),
      buildCommonsFilePath('Ford F-650 Rush Truck Centers Box Truck.jpg'),
      buildCommonsFilePath('Ford F-650 UPS truck 2.jpg'),
    ],
    mediaVerified: true,
  },
  'freightliner-m2-106-box-truck-2021': {
    heroImage: buildCommonsFilePath('Freightliner M2 box truck United Hospital Services 218079.jpg'),
    gallery: [
      buildCommonsFilePath('Freightliner M2 box truck United Hospital Services 218079.jpg'),
      buildCommonsFilePath('Durdach Bros. Freightliner M2 Mickey Truck Body.jpg'),
      buildCommonsFilePath('East Penn Manufacturing Deka Batteries Freightliner M2.JPG'),
    ],
    mediaVerified: true,
  },
  'isuzu-npr-hd-box-truck-2022': {
    heroImage: buildCommonsFilePath('Isuzu NPR box truck in red (TR).jpg'),
    gallery: [
      buildCommonsFilePath('Isuzu NPR box truck in red (TR).jpg'),
      buildCommonsFilePath('Isuzu N-Series. Refrigerated box rigid truck. Spielvogel 2013.jpg'),
      buildCommonsFilePath('Southern Truck & Custom; Isuzu NPR Billboard.jpg'),
    ],
    mediaVerified: true,
  },
  'hino-268a-straight-truck-2021': {
    heroImage: buildCommonsFilePath('Fox Ledge Water Company Hino pic20.JPG'),
    gallery: [
      buildCommonsFilePath('Fox Ledge Water Company Hino pic20.JPG'),
    ],
    mediaVerified: true,
  },
  'international-mv607-box-truck-2022': {
    heroImage: buildCommonsFilePath('2020 International MV607 Box Truck in White (Canadian Tire), Front Left, 02-22-2023.jpg'),
    gallery: [
      buildCommonsFilePath('2020 International MV607 Box Truck in White (Canadian Tire), Front Left, 02-22-2023.jpg'),
      buildCommonsFilePath('2023 International MV607 Pickup-And-Delivery Box Truck in White (Lay\'s), Front Right, 03-18-2023.jpg'),
      buildCommonsFilePath('International MV delivery truck.jpg'),
    ],
    mediaVerified: true,
  },
  'kenworth-t680-tractor-2021': {
    heroImage: buildCommonsFilePath('Kenworth T680.jpg'),
    gallery: [
      buildCommonsFilePath('Kenworth T680.jpg'),
    ],
    mediaVerified: true,
  },
  'peterbilt-579-tractor-2020': {
  ...
  'mack-granite-dump-truck-2021': {
    heroImage: buildCommonsFilePath('Mack granite SX 6X4 Allison - Chilean Army.jpg'),
    gallery: [
      buildCommonsFilePath('Mack granite SX 6X4 Allison - Chilean Army.jpg'),
      buildCommonsFilePath('NCDOT-Mack-dump-truck-20110706-5958117410.jpg'),
      buildCommonsFilePath('NCDOT-Mack-dump-truck-20110706-5957557063.jpg'),
    ],
    mediaVerified: true,
  },
...
const cars = [
  ...
  createCarRecord({
    id: 'ford-f650-box-truck-2022', badge: 'Fleet Delivery', brand: 'Ford', model: 'F-650 Box Truck', year: 2022, mileage: 48600,
    location: 'Dallas', condition: 'Certified used', priceUsd: 68900, minimumDepositUsd: 9200, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: '6-speed automatic', drivetrain: 'RWD', exteriorColor: 'White', interiorColor: 'Grey Vinyl',
    description: 'A medium-duty F-650 box truck added for delivery, moving, and regional load-haul buyers who need real cargo capacity instead of lifestyle pickup inventory.',
    features: ['26-foot cargo box', 'Hydraulic liftgate', 'Diesel V8', 'Dock-height rear door'],
    highlights: ['Dallas fleet desk for local and interstate delivery buyers', 'Real medium-duty box truck media matched to the Ford nameplate', 'Purchase and rental both available for load-haul operations'],
    delivery: { feeUsd: 590, eta: '3-6 business days after approval' },
  }),
  createCarRecord({
    id: 'freightliner-m2-106-box-truck-2021', badge: 'Regional Hauler', brand: 'Freightliner', model: 'M2 106 Box Truck', year: 2021, mileage: 61200,
    location: 'Atlanta', condition: 'Certified used', priceUsd: 74200, minimumDepositUsd: 9800, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Allison automatic', drivetrain: 'RWD', exteriorColor: 'White', interiorColor: 'Grey Cloth',
    description: 'A used Freightliner M2 106 configured for furniture, appliance, and wholesale delivery routes where buyers need a bigger commercial truck with proper load volume.',
    features: ['26-foot dry box', 'Air brakes', 'Roll-up rear door', 'Wide cargo body'],
    highlights: ['Atlanta regional-delivery stock', 'Freightliner box truck imagery verified to the exact commercial platform', 'Built for business buyers needing real box-truck capacity'],
    delivery: { feeUsd: 640, eta: '4-7 business days after approval' },
  }),
  createCarRecord({
    id: 'isuzu-npr-hd-box-truck-2022', badge: 'City Delivery', brand: 'Isuzu', model: 'NPR HD Box Truck', year: 2022, mileage: 43800,
    location: 'Chicago', condition: 'Certified used', priceUsd: 53100, minimumDepositUsd: 7200, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Automatic', drivetrain: 'RWD', exteriorColor: 'Red', interiorColor: 'Grey',
    description: 'A compact medium-duty Isuzu delivery truck suited to urban routes, store replenishment, and last-mile cargo work where a full-size semi is unnecessary.',
    features: ['16-foot box body', 'Low step-in cab', 'Liftgate', 'Tight turning circle'],
    highlights: ['Chicago city-delivery lane', 'Real Isuzu NPR box-truck gallery instead of generic cargo imagery', 'Useful for bakery, retail, and parcel operations'],
    delivery: { feeUsd: 520, eta: '3-5 business days after approval' },
  }),
  createCarRecord({
    id: 'hino-268a-straight-truck-2021', badge: 'Load Carrier', brand: 'Hino', model: '268A Straight Truck', year: 2021, mileage: 58700,
    location: 'New Jersey', condition: 'Certified used', priceUsd: 64800, minimumDepositUsd: 8700, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Automatic', drivetrain: 'RWD', exteriorColor: 'White', interiorColor: 'Grey',
    description: 'A used Hino straight truck built for route operators who need pallet-ready cargo space, dependable diesel running gear, and a true commercial delivery profile.',
    features: ['24-foot straight body', 'Pallet-ready floor', 'Roll-up cargo door', 'Air-ride driver seat'],
    highlights: ['Northeast fleet and warehouse route support', 'Verified Hino commercial truck media', 'Fits moving, beverage, and route-delivery work'],
    delivery: { feeUsd: 610, eta: '4-6 business days after approval' },
  }),
  createCarRecord({
    id: 'international-mv607-box-truck-2022', badge: 'Pickup And Delivery', brand: 'International', model: 'MV607 Box Truck', year: 2022, mileage: 52400,
    location: 'Denver', condition: 'Certified used', priceUsd: 70800, minimumDepositUsd: 9500, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Automatic', drivetrain: 'RWD', exteriorColor: 'White', interiorColor: 'Grey Cloth',
    description: 'A heavier International delivery truck for regional freight, commercial route work, and larger store distribution where a midsize box truck is no longer enough.',
    features: ['26-foot pickup-and-delivery box', 'Roll-up rear door', 'Dock-height cargo floor', 'Fleet-ready cab layout'],
    highlights: ['Denver regional fleet allocation', 'Verified International delivery-truck gallery', 'Built for retail, logistics, and wholesale distribution buyers'],
    delivery: { feeUsd: 660, eta: '4-7 business days after approval' },
  }),
  createCarRecord({
    id: 'kenworth-t680-tractor-2021', badge: 'Highway Tractor', brand: 'Kenworth', model: 'T680 Sleeper Tractor', year: 2021, mileage: 418000,
    location: 'Memphis', condition: 'Certified used', priceUsd: 96200, minimumDepositUsd: 12800, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: '12-speed automated manual', drivetrain: '6x4', exteriorColor: 'White', interiorColor: 'Grey Sleeper Trim',
    description: 'A long-haul Kenworth tractor added for buyers who need a real semi truck for interstate freight, container hauling, and contracted logistics work in the USA.',
    features: ['High-roof sleeper', 'Air-ride suspension', 'Dual fuel tanks', 'Integrated aero kit'],
    highlights: ['Memphis freight-corridor sourcing desk', 'Real Kenworth tractor media instead of pickup imagery', 'Suitable for owner-operators and fleet buyers'],
    delivery: { feeUsd: 880, eta: '5-8 business days after approval' },
  }),
  createCarRecord({
    id: 'peterbilt-579-tractor-2020', badge: 'Fleet Semi', brand: 'Peterbilt', model: '579 Day Cab Tractor', year: 2020, mileage: 463000,
    location: 'Houston', condition: 'Certified used', priceUsd: 88400, minimumDepositUsd: 11800, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Automated manual', drivetrain: '6x4', exteriorColor: 'Red and White', interiorColor: 'Charcoal',
    description: 'A used Peterbilt day cab for fuel, tanker, container, and local heavy-haul operations where the buyer wants a true commercial tractor instead of consumer pickups.',
    features: ['Day cab layout', 'Air brake system', 'Fifth-wheel hitch', 'Heavy-haul frame setup'],
    highlights: ['Houston commercial truck lane', 'Verified Peterbilt tractor image set', 'Strong fit for port, fuel, and regional contract operators'],
    delivery: { feeUsd: 860, eta: '5-8 business days after approval' },
  }),
  createCarRecord({
    id: 'mack-granite-dump-truck-2021', badge: 'Construction Hauler', brand: 'Mack', model: 'Granite Dump Truck', year: 2021, mileage: 76800,
    location: 'Charlotte', condition: 'Certified used', priceUsd: 118500, minimumDepositUsd: 15800, paymentTypes: ['full', 'installment'],
    bodyStyle: 'Truck', fuelType: 'Diesel', transmission: 'Automatic', drivetrain: '6x4', exteriorColor: 'Yellow', interiorColor: 'Grey Work Trim',
    description: 'A heavy-duty dump truck added for construction, aggregate, and site-work buyers who need serious payload capability beyond delivery vans and box trucks.',
